...
#ATS_SRC_DIR="S:/mo8557/ats/repos/ats"
#sys.path.append(os.path.join(os.environ['ATS_SRC_DIR'],'tools','meshing_ats'))
#sys.path.append('/home/u1/mo8557/ats/seacas/seacas/seacas_install/lib')
import meshing_ats
...
# 50 x 2cm cells, labeled according to dz function dz_layer1(s)
ncells = 50
dz = 0.02
...
for i in range(ncells):
    ...
    # labelingfor in the top meter varies across the domain
